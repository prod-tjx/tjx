...
Usage:
    python sla_auto_executor_batches2.py --once                # run once
    python sla_auto_executor_batches2.py --now --minutes 0,30  # run now, then on schedule
    python sla_auto_executor_batches2.py --minutes 27,57        # schedule only
    python sla_auto_executor_batches2.py                       # default :25 and :55
"""
